...
const Addhall = () => {
  ...
  const onFinish = (fieldsValue) => {
    ...
    axios
      .post(`${baseurl}/hall/create/`, fmData, config)
      .then((res) => {
  ...
  return (
    <div>
      <Title level={2} className="mt-3 mb-2 text-center">
        Add a Hall
      </Title>
      <Form
        name="addhall"
      ...
      >
        ...
        <Form.Item
          ...
          name="max_booking_day"
          rules={[
            { required: true, message: "Maximum booking days are required" },
          ]}
        >
          <InputNumber />
        </Form.Item>
